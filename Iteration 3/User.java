...
public class User {
   ...
   */
   ...
   public Customer getCustomer(int cusNum) {
   
      net.sqlitetutorial.DB_App app = new net.sqlitetutorial.DB_App();
      String res = app.selectCustomer(cusNum);
      if (res == null)
         return new Customer();
      String[] tokens = res.split("#");
      if(res != null)
         return new Customer(tokens[0], cusNum, Integer.parseInt(tokens[1]));
      return new Customer();
   }

   public void updatePoints(Customer cus){
      if(cus.getIDNum() < 0){
         return;
      }
      net.sqlitetutorial.DB_App app = new net.sqlitetutorial.DB_App();
      app.savePoints(cus.getIDNum(),cus.getPoints());
   }
   ...
   public boolean newCustomer(String newName, String pass) {
      net.sqlitetutorial.DB_App app = new net.sqlitetutorial.DB_App();
      app.insertCustomer(newName);
   ...
   */
   public Transaction beginTransaction(int cusNum){
      net.sqlitetutorial.DB_App app = new net.sqlitetutorial.DB_App();
      return new Transaction(idNum,cusNum, app.getCurrentTransactionID());
   }
   ...
   */
   public boolean finalizeTransaction(Transaction transaction){
      ...
      int cusNum = Integer.parseInt(tokens[3]);
      if(total > 0){
         net.sqlitetutorial.DB_App app = new net.sqlitetutorial.DB_App();
         app.insertOrder(orderNum,dateTime,total, cusNum);
      }
      return true;
   }

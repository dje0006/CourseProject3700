...
public class Viewer extends JFrame implements ActionListener {
   ...
   */
   private Viewer() {
      ...
      window.setVisible(true);
   	...
   	////////////////MANAGER PANEL START/////////////////////////
   	//set grid style layout
      manPan.setLayout(new GridLayout(5,1));
   ...
   */
   ...
   private void getUser() {
      ...
      JPasswordField pf = new JPasswordField(); // new
      ...
      if (option == JOptionPane.CANCEL_OPTION)
         ...
         //currentUser = currentUser.getUser(userName.getText(), password.getText());	   
      }
   }
   ...
   */
   ...
   /*
   * Performs the copying of a picture to the designated path.
   */
   ...
   private void addUser() {
      ...
      //Object[] fields = {"Username:" , userName,"Password:", pass, "", manOption};
      ...
      //currentUser.newUser(name, isMan, password);
